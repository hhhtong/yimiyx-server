...
export interface ObjOrObjArr {
  obj: Object | Object[]
}

const transformObjKey = (obj: ObjOrObjArr, fn: Function): Object | Object[] => {
...
export default {
  moment,
  toCamelObj(obj: ObjOrObjArr): Object | Object[] { // 将Object内的key转为小驼峰命名
    return transformObjKey(obj, (key: string) => camelCase(key).replace(/Id$/, 'ID'))
  },
  toSnakeObj(obj: ObjOrObjArr): Object | Object[] { // 将Object内的key转为下划线分割命名
